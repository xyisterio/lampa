(function () {
  ...
  function startPlugin() {
    ...
    style = style.replace('</style>', '.cub-collection-create__center{width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.1);border-radius:0.5em}.cub-collection-create__center svg{width:60%;height:60%}.cub-collection-card--create .card__img{display:none}</style>');
